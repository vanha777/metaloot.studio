...
const SignIn: React.FC = () => {
  ...
  const [, setStudio] = useLocalStorage<GameStudio | null>("gameStudio", null);
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    // Initialize dummy studio data
    const dummyStudio: GameStudio = {
      id: "dummy-studio-1",
      name: "Test Studio",
      description: "A test game development studio",
      logo: "https://tzqzzuafkobkhygtccse.supabase.co/storage/v1/object/public/biz_touch/crypto-ql/squidgame",  // optional
      avatar: "https://tzqzzuafkobkhygtccse.supabase.co/storage/v1/object/public/biz_touch/crypto-ql/view-futuristic-music-robot-droid.png"  // optional
    };

    // Save studio data to localStorage
    setStudio(dummyStudio);
  ...
  return (
    <DefaultLayout>
      <Head>
        <title>Next.js SignIn Page | TailAdmin - Next.js Dashboard Template</title>
        <meta name="description" content="This is Next.js Signin Page TailAdmin Dashboard Template" />
      </Head>
